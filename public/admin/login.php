...
echo '<link rel="stylesheet" href="/admin/assets/admin.css?v=1"></head><body class="center">';
echo '<form class="card narrow" method="post" action="/admin/login.php" autocomplete="on">';
echo '<h1>HAMKOR SAVDO admin</h1>';
