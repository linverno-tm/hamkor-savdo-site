...
hs_head('Kirish — HAMKOR SAVDO admin');
echo '<body class="center">';
echo '<form class="card narrow auth-card" method="post" action="/admin/login.php" autocomplete="on">';
echo '<div class="auth-top"><div class="auth-icon">' . hs_icon('shield') . '</div>' . hs_theme_toggle() . '</div><h1>HAMKOR SAVDO</h1><p class="muted">Boshqaruv paneliga kirish</p>';
